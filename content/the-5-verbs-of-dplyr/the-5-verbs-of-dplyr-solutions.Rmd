...
**Question:** Mike and cindy both got a 4 for their math score. Explain why why Mike has a higher "math_score_centered_by_sex" score.
...
**Answer:** We are subtracting the mean math score for that person's sex off of their score. Mike has a higher "math_score_centered_by_sex" because males did worse on average on math and so a small number is subtracted off of his score of 4.
...
**Question:** Remove any students with smith as a teacher, then find the mean math_score by sex.
